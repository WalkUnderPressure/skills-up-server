...
exports.MockPostDetailsDataTwo = exports.MockPostDetailsData = void 0;
...
const MockPostDetailsData = {
    ...
    blocks: [
        ...
        {
            id: '2',
            type: types_1.PostBlockType.CODE,
        ...
        {
            id: '4',
            type: types_1.PostBlockType.IMAGE,
            src: 'https://wavelop.com/static/528bbb228615a3160dcbe094c6fe905e/ba228/js-pipe-function.png',
            title: 'A pipe function is a function that accepts a series of functions, which process an input parameter and return a output which will be the input for the next function.',
        },
        {
            id: '5',
            type: types_1.PostBlockType.TEXT,
...
exports.MockPostDetailsData = MockPostDetailsData;
const MockPostDetailsDataTwo = {
    ...
    tags: [types_1.PostTagsMap.SCIENCE],
    blocks: [
        {
            id: '1',
            type: types_1.PostBlockType.TEXT,
...
exports.MockPostDetailsDataTwo = MockPostDetailsDataTwo;
